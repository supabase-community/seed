...
describe('dataModel', () => {
  ...
  test('it correctly convert an introspected structure with two tables named the same in different schemas into a data model', async () => {
    // arrange
    // act
  ...
  test('it correctly convert an introspected structure into a data model with unique constraints', async () => {
