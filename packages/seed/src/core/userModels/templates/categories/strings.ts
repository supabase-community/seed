...
export const strings: TypeTemplates = {
  ...
  HACKER_PHRASE: copycatTemplate("oneOfString", {
    args: [
      [
        ...
        `Try to transmit the SQL protocol, maybe it will synthesize the 1080p adapter!`,
        ...
        `We need to copy the cross-platform GB adapter!`,
        ...
        `You can't generate the firewall without programming the redundant HDD adapter!`,
  ...
  LOCATION_LATITUDE: copycatTemplate("int", { options: { min: -90, max: 90 } }),
