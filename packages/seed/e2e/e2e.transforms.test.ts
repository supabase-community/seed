...
for (const [dialect, adapter] of adapterEntries) {
  ...
  test("default database value with model scalar override", async () => {
  ...
  test("default database value with model function override", async () => {
    const schema: DialectRecordWithDefault = {
      default: `
        create table team (
          id serial primary key,
  ...
  test("default database value with plan scalar override", async () => {
    const schema: DialectRecordWithDefault = {
      default: `
        create table team (
          id serial primary key,
